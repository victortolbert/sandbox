...
export function useSeo({ title, description, image }) {
  const bits = [
    ...
    { hid: 'twitter:creator', name: 'twitter:creator', content: '@victortolbert' },
    { hid: 'twitter:site', name: 'twitter:site', content: '@victortolbert' },
    { hid: 'twitter:card', name: 'twitter:card', content: 'summary_large_image' },
  ]

  useHead({ title: `${title} | Prototype`, description }, bits)
}
